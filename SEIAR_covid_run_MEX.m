%% Data from The Ministry of Health of Mexico with the number of infections, deaths, and recovered cases by state
I_globe=readtable('Confirmed_Infected_National.csv','ReadRowNames',true);
date=datetime(I_globe{1,1:end},'Format','dd/MM/yy');

D_globe=readtable('Confirmed_Death_National.csv','ReadRowNames',true);

R_globe=readtable('Confirmed_Recuperated_National.csv','ReadRowNames',true);
...
date=date(2:end);               %Day 1 corresponds to 13/March/2020
...
%x0 contains the initial guess for the parameter values
